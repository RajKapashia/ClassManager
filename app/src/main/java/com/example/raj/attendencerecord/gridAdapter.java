...
public class gridAdapter extends BaseAdapter{
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        else if(names.get(position).toString().equals("STUDENT"))
        {
            imageView.setImageResource(R.drawable.stud);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity, AppBase.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
        ...
        else if(names.get(position).toString().equals("TEACHER"))
        {
        ...
        else if(names.get(position).toString().equals("SETTING"))
        {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity, SettingsActivity.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
